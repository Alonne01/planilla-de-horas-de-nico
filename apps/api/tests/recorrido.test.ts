...
const CIRCUITO: PasoCircuito[] = [
  ...
  { orden: 2, nombrePaso: 'Aprobación Coordinador', rolAprobador: 'COORDINADOR', usuarioEspecificoId: null, requiereComentarioRechazo: true, tiempoLimiteHoras: null, notificarRoles: [] },
  { orden: 3, nombrePaso: 'Cierre RRHH', rolAprobador: 'RRHH', usuarioEspecificoId: null, requiereComentarioRechazo: true, tiempoLimiteHoras: null, notificarRoles: [] },
];

const ts = (min: number) => new Date(2026, 6, 25, 10, min);
